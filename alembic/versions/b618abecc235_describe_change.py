...
down_revision: str | None = "ce00fd6af919"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "gender",
            sa.Enum("MALE", "FEMALE", "NON_BINARY", "OTHER", "PREFER_NOT_TO_SAY", name="gender"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mood",
            sa.Enum("FELIZ", "BEM", "CANSADO", "TRISTE", "IRRITADO", name="mood"),
            nullable=False,
        ),
        sa.Column(
