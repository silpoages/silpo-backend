...
from app.schemas.mood_log import MoodLogCreate, MoodLogGet, MoodLogListResponse, MoodLogRead
...
async def get_mood_log(
    ...
    logs = await service.list_by_date(user_id=current_user.id, log_date=payload.date)
